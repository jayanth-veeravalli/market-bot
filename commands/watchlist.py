...
async def watchlist_fetch(interaction: discord.Interaction):
    await interaction.response.send_message(watchlist_service.fetch_all())
...
async def watchlist_add(interaction: discord.Interaction, ticker: str):
    await interaction.response.send_message(watchlist_service.add_ticker(ticker))
...
async def watchlist_remove(interaction: discord.Interaction, ticker: str):
    await interaction.response.send_message(watchlist_service.remove_ticker(ticker))
